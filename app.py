...
def main():
    string = "RetroRatePredict"
    st.set_page_config(page_title=string, page_icon="🚗") 
    st.title("RetroRatePredict 🚗")
    ...
    st.write("Unlock the Road to Confidence: Know Your Car's True Worth!")
    st.write("Revolutionizing Car Transactions: Predicting Prices with Precision.")
